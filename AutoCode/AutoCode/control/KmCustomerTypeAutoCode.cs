...
namespace AutoCode
{
    public class KmCustomerTypeAutoCode:IAutoCode
    {
        ...
        public KmCustomerTypeAutoCode(AutoCodeParams acp)
        {
            _acp = acp;
        }
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "InitKmCustomerType").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "KmCustomerType").ToString(), _acp.CPreTag + _acp.CP.CName,
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "DeclearKmCustomerType").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        }
