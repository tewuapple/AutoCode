...
namespace AutoCode
{
    public class KmComboBoxAutoCode : IAutoCode
    {
        ...
        public KmComboBoxAutoCode(AutoCodeParams acp)
        {
            _acp = acp;
        }
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "InitKmComboBox").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "KmComboBox").ToString(), _acp.CPreTag + _acp.CP.CName,
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "DeclearKmComboBox").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        }
