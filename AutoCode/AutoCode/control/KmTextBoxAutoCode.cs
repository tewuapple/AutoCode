...
namespace AutoCode
{
    public class KmTextBoxAutoCode : IAutoCode
    {
        ...
        public KmTextBoxAutoCode(AutoCodeParams acp)
        {
            _acp = acp;
        }
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "InitKmTextBox").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "KmTextBox").ToString(), _acp.CPreTag + _acp.CP.CName,
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "DeclearKmTextBox").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        }
