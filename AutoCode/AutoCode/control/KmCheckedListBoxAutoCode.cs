...
namespace AutoCode
{
    public class KmCheckedListBoxAutoCode:IAutoCode
    {
        ...
        public KmCheckedListBoxAutoCode(AutoCodeParams acp)
        {
            _acp = acp;
        }
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "InitKmCheckedListBox").ToString(),_acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "KmCheckedListBox").ToString(), _acp.CPreTag + _acp.CP.CName,
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "DeclearKmCheckedListBox").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        }
