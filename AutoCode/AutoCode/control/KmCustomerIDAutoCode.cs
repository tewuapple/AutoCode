...
namespace AutoCode
{
    public class KmCustomerIDAutoCode : IAutoCode
    {
        ...
        public KmCustomerIDAutoCode(AutoCodeParams acp)
        {
            _acp = acp;
        }
        #region IAutoCode ≥…‘±
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "InitKmCustomerID").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "KmCustomerID").ToString(), _acp.CPreTag + _acp.CP.CName,
        ...
        {
            code += string.Format(_acp.CXML.GetValue(_acp.CSection, "DeclearKmCustomerID").ToString(), _acp.CPreTag + _acp.CP.CName) + Environment.NewLine;
        }
